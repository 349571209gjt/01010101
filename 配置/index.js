...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxab3d340c03c188cb',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '5b4202ef5003e1460fdbb35021319715',
   ...
   */
  USERS: ["ovhhz6hDQTFfS29CHGE24huNxuCs"],
    {
      // 想要发送的人的名字
      name: '老婆0'
      ...
      id: '',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'mO3hYNMauSQYgy-Fj9vrKWtLwLNqcCCNA8T3CTe6f_E',
      // 所在省份
      province: '广西',
      // 所在城市
      city: '梧州',
